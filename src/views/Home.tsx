    ...
    <div className="page">
      <div className="page__container">
        ...
        <div className="page__container__wallpaper">
          {/* <img src="/assets/images/wallpaper2.jpeg" alt="" className="bg-image" /> */}
          <img src="https://mir-s3-cdn-cf.behance.net/project_modules/1400/aae729210917495.67196a429b9f1.png" alt="" className="bg-image" />
          <div className="search-box">
            <h1 className="scroll-m-20 text-4xl text-white font-extrabold tracking-tight">클라우드 컴퓨팅 개인 과제 <br /> 이미지 검색 사이트: ImagePicker </h1>
        ...
        <footer className="page__container__footer">
          <PaginationFooter totalPages={34} currentPage={page} handlePage={setPage} />
        </footer>
      </div>
    </div>
  );
